...
def compare_model_and_actual_stock_results(data, calculated_data, inputs):
    ...
    plot_all_countries(validation_step1_df, inputs["config_validation_step1"], columns_to_plot, None)
    ...
    plot_all_countries(validation_step2_df, inputs["config_validation_step2"], columns_to_plot, None)
    calculate_rmse(validation_step1_df, inputs["config_validation_rmse_step1"])
    calculate_rmse(validation_step2_df, inputs["config_validation_rmse_step2"])
    return
