...
def get_csp_plots(survival_rates, pdf_parameters, config_all, config_group):
    ...
    country_group = 2
    plot_group_of_countries(pdf_parameters, survival_rates, country_group, config_group)
    plot_all_countries(pdf_parameters, survival_rates, config_all, activate_weibull=1,
                       activate_weibull_and_normal=0)
    plot_all_countries(pdf_parameters, survival_rates, config_all, activate_weibull=0,
